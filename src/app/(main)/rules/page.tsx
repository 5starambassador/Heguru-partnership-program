...
export default async function RulesPage() {
  ...
  const sortedSlabs = [...rawSlabs].sort(
    (a, b) => a.referralCount - b.referralCount,
  );
        ...
        <div className="flex items-center gap-4">
          <div>
            ...
            <p className="text-[10px] font-bold text-gray-500 uppercase tracking-[0.25em]">
              Operational Protocol & Reward Algorithms
            </p>
          </div>
        </div>
          ...
          <ul className="space-y-5 text-sm font-medium text-slate-600">
            <li className="flex gap-4 items-start">
              ...
              <span className="leading-relaxed">
                Refer parents to Heguru using your unique code or link. If they
                join, you earn points towards your tier.
              </span>
            </li>
            <li className="flex gap-4 items-start">
              <div className="w-6 h-6 rounded-full bg-amber-500/10 flex items-center justify-center shrink-0 mt-0.5 border border-amber-500/20">
              ...
              <span className="leading-relaxed">
                Benefits apply directly to your{" "}
                <span className="text-slate-900 font-bold">Child's Fee</span>{" "}
                (for Parents) or{" "}
                <span className="text-slate-900 font-bold">Bank Transfer</span>{" "}
                (for Staff/Alumni).
              </span>
            </li>
            <li className="flex gap-4 items-start">
              ...
              <span className="leading-relaxed">
                <span className="text-amber-600 font-bold uppercase tracking-wider text-xs font-heading">
                  Activation Rule:
                </span>{" "}
                Just{" "}
                <span className="text-slate-900 font-bold">
                  1 Confirmed Referral
                </span>{" "}
                per year keeps your benefits active.
              </span>
            </li>
          </ul>
        </PageItem>
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <span
                      className={`text-[10px] font-black uppercase tracking-[0.2em] px-2.5 py-1 rounded-full border ${theme.tagBg}`}
                    >
                      {b.label}
                    </span>
                  </div>
                  ...
                  <div className="flex items-baseline gap-1 mb-2">
                    <span
                      className={`text-5xl font-black tracking-tighter font-heading ${theme.percentText}`}
                    >
                      {b.percent}%
                    </span>
                  </div>
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest">
                  Partner Program Privileges
                </p>
              </div>
            </div>
            <p className="text-slate-600 text-sm font-medium mb-6 max-w-xl leading-relaxed">
              Qualify for Long Term Benefits next year by completing 5 Referrals
              this year. Unlock the prestigious Partner status.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex justify-between items-center p-5 bg-slate-50 rounded-xl border border-slate-200 hover:bg-slate-100/70 transition-colors">
                <div className="flex flex-col">
                  <span className="text-[10px] font-black text-slate-500 uppercase tracking-widest mb-1 font-heading">
                    Base Benefit
                  </span>
                  <span className="text-[11px] text-slate-400 font-bold">
                    Guaranteed Historic Base Sum
                  </span>
                </div>
              ...
              <div className="flex justify-between items-center p-5 bg-emerald-50/50 rounded-xl border border-emerald-200 hover:bg-emerald-50 transition-colors">
                <div className="flex flex-col">
                  <span className="text-[10px] font-black text-emerald-700 uppercase tracking-widest mb-1 font-heading">
                    New Referral Yield
                  </span>
                ...
                <span className="font-black text-2xl text-emerald-600">
                  +{globalYield}%{" "}
                  <span className="text-xs align-top opacity-80 italic">
                    Yield
                  </span>
                </span>
              </div>
        ...
        {/* <PageItem className="bg-rose-50/50 rounded-xl p-6 border border-rose-200/80 text-center relative overflow-hidden shadow-sm">
          <div className="relative z-10">
            <p className="font-black text-base text-rose-950 uppercase tracking-tight mb-1 font-heading">
              Registration closes{" "}
              <span className="text-[var(--primary-orange)] font-extrabold">
                31 January 2026
              </span>
            </p>
