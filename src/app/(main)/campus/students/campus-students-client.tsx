...
export function CampusStudentsClient({ students: initialStudents, query }: CampusStudentsClientProps) {
    ...
    return (
        <div className="space-y-4">
            ...
            <div className="flex justify-between items-center bg-white p-4 rounded-md border border-gray-150 shadow-sm">
                <div className="bg-gray-50 rounded-md px-3 py-2 flex items-center gap-2 w-72 focus-within:ring-2 focus-within:ring-primary-maroon/20 transition-all">
                ...
                <button
                    ...
                    className="inline-flex items-center gap-2 px-4 py-2 bg-primary-maroon text-white rounded-md text-sm font-semibold hover:bg-primary-maroon/90 shadow-sm transition-all active:scale-95"
                >
                    <Download size={16} />
                    Export PDF
                </button>
            ...
            <div className="flex items-center justify-between px-2">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <span className="text-[10px] font-semibold text-gray-500 uppercase tracking-wider">Live Data</span>
                </div>
            </div>
                    ...
                    <table className="w-full text-left border-collapse">
                        <thead>
                            <tr className="bg-gray-50/50">
                                <th className="py-5 px-6 text-[10px] font-semibold text-gray-500 uppercase tracking-wider">Student info</th>
                                <th className="py-5 px-6 text-[10px] font-semibold text-gray-500 uppercase tracking-wider hidden md:table-cell">Grade / Section</th>
                                <th className="py-5 px-6 text-[10px] font-semibold text-gray-500 uppercase tracking-wider hidden sm:table-cell">Parent Details</th>
                                <th className="py-5 px-6 text-[10px] font-semibold text-gray-500 uppercase tracking-wider hidden lg:table-cell">Status</th>
                                    ...
                                    <React.Fragment key={student.studentId}>
                                        ...
                                        >
                                            ...
                                            <td className="py-5 px-6 hidden lg:table-cell">
                                                <span className={`inline-flex items-center px-2.5 py-0.5 rounded-md text-xs font-semibold ${student.status === 'Active' ? 'bg-green-50 text-green-700 border border-green-100' :
                                                    student.status === 'Inactive' ? 'bg-red-50 text-red-700 border border-red-100' :
                                                        ...
                                                        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-8">
                                                            ...
                                                            <div className="md:col-span-8 space-y-6">
                                                                <div className="grid grid-cols-2 gap-4">
                                                                    <div className="bg-white p-4 rounded-md border border-gray-200 shadow-sm">
                                                                        <div className="flex items-center gap-2 mb-2 text-primary-maroon">
                                                                            ...
                                                                            <span className="text-[10px] font-semibold uppercase tracking-wider opacity-60">Academic Details</span>
                                                                        </div>
                                                                        {editingId === student.studentId ? (
                                                                            <div className="space-y-3 mt-4">
                                                                                <div>
                                                                                    <label className="text-[10px] font-semibold text-gray-500 uppercase">Roll Number</label>
                                                                                    <input
                                                                                        type="text"
                                                                    ...
                                                                    <div className="bg-white p-4 rounded-md border border-gray-200 shadow-sm">
                                                                        <div className="flex items-center gap-2 mb-2 text-primary-gold">
                                                                            <Activity size={16} />
                                                                            <span className="text-[10px] font-semibold uppercase tracking-wider opacity-60">Status Management</span>
                                                                        </div>
                                                                        {editingId === student.studentId ? (
                                                                            <div className="mt-4">
                                                                                <label className="text-[10px] font-semibold text-gray-500 uppercase">Current Status</label>
                                                                                <select
                                                                                    className="w-full bg-gray-50 border border-gray-200 rounded-md p-2 text-sm mt-1"
                                                                            ...
                                                                            <div className="mt-2">
                                                                                <span className={`inline-flex items-center px-2.5 py-0.5 rounded-md text-xs font-semibold ${student.status === 'Active' ? 'bg-green-50 text-green-600 border border-green-100' : 'bg-red-50 text-red-600 border border-red-100'}`}>
                                                                                    {student.status}
                                                                                </span>
                                                                ...
                                                                <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
                                                                    <div className="flex items-center justify-between mb-4">
                                                                        ...
                                                                        <span className="text-[10px] font-semibold bg-blue-50 text-blue-600 px-2 py-0.5 rounded-md uppercase">2025-26 Academic Year</span>
                                                                    </div>
                                                                    <div className="grid grid-cols-3 gap-6">
                                                                        <div>
                                                                            <p className="text-[10px] font-semibold text-gray-500 uppercase">Annual Base Fee</p>
                                                                            <p className="text-xl font-bold text-gray-900">₹{student.baseFee?.toLocaleString()}</p>
                                                                        </div>
                                                                        <div>
                                                                            <p className="text-[10px] font-semibold text-gray-500 uppercase">Scholarship/Discount</p>
                                                                            <p className="text-xl font-bold text-green-600">{student.discountPercent}% OFF</p>
                                                                        </div>
                                                                        <div className="relative">
                                                                            <div className="absolute -inset-2 bg-primary-gold/10 rounded-md blur-lg animate-pulse"></div>
                                                                            <div className="relative">
                                                                                <p className="text-[10px] font-semibold text-primary-gold uppercase">Final Payable</p>
                                                            ...
                                                            <div className="md:col-span-4 flex flex-col gap-3">
                                                                <button
                                                                    ...
                                                                    disabled={isSaving}
                                                                    className={`flex items-center justify-center gap-2 w-full py-4 rounded-md font-semibold transition-all ${editingId === student.studentId
                                                                        ? 'bg-green-600 text-white hover:bg-green-700 shadow-sm'
                                                                        : 'bg-primary-gold text-white hover:bg-primary-gold/90 shadow-sm'
                                                                        }`}
                                                                 >
                                                                    {isSaving ? (
                                                                ...
                                                                {editingId === student.studentId ? (
                                                                    <button
                                                                        ...
                                                                        className="flex items-center justify-center gap-2 w-full py-4 bg-white border border-gray-200 text-gray-600 rounded-md font-semibold hover:bg-gray-50 transition-all"
                                                                    >
                                                                        <X size={18} /> Cancel
                                                                    </button>
                                                                ) : (
                                                                    <button
                                                                        ...
                                                                        className="flex items-center justify-center gap-2 w-full py-4 bg-[#25D366]/10 text-[#25D366] rounded-md font-semibold hover:bg-[#25D366]/20 transition-all"
                                                                    >
                                                                        Contact Parent
                                                                    </button>
                                                                )}
                                ...
                                <tr>
                                    <td colSpan={5} className="py-20 text-center">
                                        <div className="flex flex-col items-center gap-3">
                                            ...
                                            <button onClick={() => window.location.href = '/campus/students'} className="text-primary-maroon font-semibold text-sm">Clear Search</button>
                                        </div>
                                    </td>
                                </tr>
                            )}
