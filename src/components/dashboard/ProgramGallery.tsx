            ...
            <div className="flex items-center justify-between px-4 pb-2 pt-2">
                <div className="relative">
                    <div className="flex items-center gap-1.5">
                        ...
                        <h2 className="text-2xl font-black text-[var(--deep-black)] uppercase tracking-tighter leading-none font-heading">
                            Exclusives
                        </h2>
                    </div>
                            ...
                            >
                                ...
                                <div className="mt-auto relative z-10 flex gap-4">
                                    <button
                                        ...
                                        className="flex-grow py-2 rounded-full bg-green-800 text-white font-black text-[13px] uppercase tracking-[0.2em] flex items-center justify-center gap-2 active:scale-[0.98] transition-all hover:opacity-90 shadow-sm"
                                    >
                                    ...
                                    <button
                                        ...
                                        className="w-14 h-14 rounded-full flex items-center justify-center shadow-sm active:scale-95 transition-all flex-shrink-0"
                                    >
                                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22The attached reference screenshot is STRICTLY FOR THE ADMIN PANEL DASHBOARD PAGE." viewBox="0 0 24 24" fill="none" stroke="#FFFFFF" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><path d="M4 12v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-8" /><polyline points="16 6 12 2 8 6" /><line x1="12" y1="2" x2="12" y2="15" /></svg>
                                    </button>
                                </div>
                            </motion.div>
                        </div>
