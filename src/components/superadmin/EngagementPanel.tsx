...
const WhatsAppConfigPanel = dynamic(() => import('./WhatsAppConfigPanel'), { 
    ssr: false,
    loading: () => <div className="h-96 w-full animate-pulse bg-gray-50 rounded-xl border border-gray-100" />
})
...
export function EngagementPanel({ permissions }: EngagementPanelProps) {
    ...
    return (
        <div className="space-y-10 animate-in fade-in slide-in-from-bottom-6 duration-700">
            ...
            <div className="flex p-1.5 bg-white/40 backdrop-blur-md rounded-md border border-white/20 w-fit shadow-sm relative z-20">
                <button
                    onClick={() => setActiveTab('overview')}
                    className={`relative px-8 py-3.5 text-[11px] font-semibold uppercase tracking-[0.2em] transition-all rounded-md ${activeTab === 'overview' ? 'text-white' : 'text-gray-400 hover:text-gray-600'
                        }`}
                >
                    {activeTab === 'overview' && (
                        <motion.div
                ...
                <button
                    ...
                    className={`relative px-8 py-3.5 text-[11px] font-semibold uppercase tracking-[0.2em] transition-all rounded-md ${activeTab === 'campaigns' ? 'text-white' : 'text-gray-400 hover:text-gray-600'
                        }`}
                >
                    {activeTab === 'campaigns' && (
                        <motion.div
                ...
                {(permissions === undefined || (permissions as any).whatsappConfig?.access) && (
                    <button
                        ...
                        className={`relative px-8 py-3.5 text-[11px] font-semibold uppercase tracking-[0.2em] transition-all rounded-md ${activeTab === 'automation' ? 'text-white' : 'text-gray-400 hover:text-gray-600'
                            }`}
                    >
                    ...
                    >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            {[
                                ...
                                <motion.div
                                    ...
                                    className="bg-white/40 backdrop-blur-md p-6 md:p-8 rounded-xl border border-white/20 shadow-sm relative group overflow-hidden"
                                >
                                    ...
                                    <div className={`w-12 h-12 ${s.bg} ${s.color} rounded-xl flex items-center justify-center mb-6 shadow-sm border border-white/10 group-hover:scale-110 transition-transform`}>
                                        <s.icon size={20} />
                                    </div>
                                    <p className="text-[10px] font-semibold text-gray-500 uppercase tracking-[0.2em] mb-1">{s.label}</p>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                            ...
                            <motion.div
                                ...
                                className="bg-white/60 backdrop-blur-md rounded-xl border border-white/40 p-6 md:p-10 shadow-sm relative overflow-hidden group border-b-4 border-b-amber-500/20"
                            >
                                ...
                                <div className="relative z-10">
                                    <div className="flex items-center justify-between mb-8">
                                        <div className="w-16 h-16 bg-amber-500 text-white rounded-xl flex items-center justify-center shadow-xl shadow-amber-100 border-4 border-white">
                                            <Zap size={28} fill="currentColor" />
                                        </div>
                                        <div className="text-right">
                                            <span className="text-[10px] font-semibold bg-amber-100 text-amber-600 px-3 py-1 rounded-md uppercase tracking-widest border border-amber-200">System Optimizer</span>
                                        </div>
                                    </div>

                                    <h3 className="text-2xl font-black text-gray-900 mb-4 uppercase tracking-tighter">Re-engagement Core</h3>
                                    ...
                                    <div className="grid grid-cols-2 gap-4 mb-10">
                                        <div className="bg-white/40 border border-white p-4 rounded-md">
                                            <Clock size={16} className="text-amber-500 mb-2" />
                                            <p className="text-[9px] font-semibold text-gray-500 uppercase tracking-widest">Protocol</p>
                                            <p className="text-xs font-semibold text-gray-900">14-Day Inactivity</p>
                                        </div>
                                        <div className="bg-white/40 border border-white p-4 rounded-md">
                                            <MousePointer2 size={16} className="text-amber-500 mb-2" />
                                            <p className="text-[9px] font-semibold text-gray-500 uppercase tracking-widest">Status</p>
                                            <p className="text-xs font-semibold text-gray-900">{isReengagementScheduled ? (isReengagementScheduled === 'PROCESSING' ? 'Running...' : 'Scheduled') : 'Standard Nudge'}</p>
                                        </div>
                                    </div>
                                    ...
                                    <button
                                        ...
                                        className="w-full py-5 bg-gray-900 hover:bg-black text-white rounded-md font-semibold text-[11px] uppercase tracking-[0.25em] shadow-sm transition-all flex items-center justify-center gap-3 disabled:opacity-70 group/btn overflow-hidden relative"
                                    >
                            ...
                            <motion.div
                                initial={{ opacity: 0, scale: 0.95 }}
                                animate={{ opacity: 1, scale: 1 }}
                                className="bg-white/60 backdrop-blur-md rounded-xl border border-white/40 p-6 md:p-10 shadow-sm relative overflow-hidden group border-b-4 border-b-rose-500/20"
                            >
                                ...
                                <div className="relative z-10">
                                    <div className="flex items-center justify-between mb-8">
                                        <div className="w-16 h-16 bg-rose-500 text-white rounded-xl flex items-center justify-center shadow-xl shadow-rose-100 border-4 border-white">
                                            <ShieldAlert size={28} />
                                        </div>
                                        <div className="text-right">
                                            <span className="text-[10px] font-semibold bg-rose-100 text-rose-600 px-3 py-1 rounded-md uppercase tracking-widest border border-rose-200">Data Integrity</span>
                                        </div>
                                    </div>

                                    <h3 className="text-2xl font-black text-gray-900 mb-4 uppercase tracking-tighter">Campus Enforcement</h3>
                                    <p className="text-sm text-gray-500 mb-8 leading-relaxed font-medium">
                                    ...
                                    <div className="grid grid-cols-2 gap-4 mb-10">
                                        <div className="bg-white/40 border border-white p-4 rounded-md">
                                            ...
                                            <p className="text-[9px] font-semibold text-gray-500 uppercase tracking-widest">Targeted</p>
                                            <p className="text-xs font-semibold text-gray-900">{campusStats?.count ?? '...'} Ambassadors</p>
                                        </div>
                                        <div className="bg-white/40 border border-white p-4 rounded-md">
                                            <ShieldAlert size={16} className="text-rose-500 mb-2" />
                                            <p className="text-[9px] font-semibold text-gray-500 uppercase tracking-widest">Status</p>
                                            <p className="text-xs font-semibold text-gray-900">{isEnforcementScheduled ? (isEnforcementScheduled === 'PROCESSING' ? 'Dispatching...' : 'Scheduled') : 'Mandatory Profile Update'}</p>
                                        </div>
                                    </div>
                                    ...
                                    <button
                                        ...
                                        className="w-full py-5 bg-rose-600 hover:bg-rose-700 text-white rounded-md font-semibold text-[11px] uppercase tracking-[0.25em] shadow-sm transition-all flex items-center justify-center gap-3 disabled:opacity-70 group/btn overflow-hidden relative"
                                    >
                            ...
                            <div className="space-y-6">
                                <h4 className="text-[10px] font-semibold text-gray-500 uppercase tracking-[0.3em] px-2">Historical Logs</h4>
                                ...
                                <AnimatePresence mode="popLayout">
                                    {lastResult ? (
                                        <motion.div
                                            ...
                                            className="bg-emerald-500/90 backdrop-blur-md rounded-xl p-6 md:p-10 text-white shadow-sm flex flex-col justify-center min-h-[300px] relative overflow-hidden"
                                        >
                                            <div className="absolute top-0 right-0 w-64 h-64 bg-white/10 rounded-full translate-x-1/2 -translate-y-1/2 blur-3xl" />
                                            <CheckCircle2 size={64} className="mb-6 opacity-30" />
                                            <h3 className="text-xl font-black uppercase tracking-tighter mb-1">Impact Confirmed</h3>
                                            <p className="text-8xl font-black tracking-tighter leading-none mb-4">
                                                {lastResult.sent}
                                            </p>
                                            <p className="text-[11px] font-semibold uppercase tracking-[0.3em] opacity-60">Successive Dispatches Delivered</p>
                                            <div className="mt-8 pt-6 border-t border-white/10 flex items-center gap-2">
                                                <Clock size={12} className="opacity-60" />
                                                <span className="text-[10px] font-semibold opacity-60 uppercase tracking-widest">Logged: {lastResult.time.toLocaleTimeString()}</span>
                                            </div>
                                        </motion.div>
                                    ) : (
                                        <div className="flex flex-col items-center justify-center bg-gray-50/50 border-2 border-dashed border-gray-200/50 rounded-xl p-10 min-h-[300px] text-center">
                                            ...
                                            <h4 className="text-xs font-semibold text-gray-500 uppercase tracking-widest">Awaiting First Pulse</h4>
