...
export function ResetPasswordModal({ isOpen, onClose, target }: ResetPasswordModalProps) {
    ...
    return (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 xl:pl-[280px]">
            <div className="absolute inset-0 bg-slate-900/50 backdrop-blur-sm" onClick={onClose} />
            <div className="relative bg-white rounded-2xl p-6 w-full max-w-[400px] shadow-2xl animate-in fade-in zoom-in-95 duration-200">
