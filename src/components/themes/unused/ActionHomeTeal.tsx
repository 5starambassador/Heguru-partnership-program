...
export function ActionHomeTeal({ user, recentReferrals, whatsappUrl, monthStats }: ActionHomeTealProps) {
            ...
            >
                ...
                <div className="relative z-10 w-full">
                    <div className="mb-8">
                        <motion.p
                            ...
                            className="text-teal-100 font-medium tracking-widest text-xs md:text-sm uppercase mb-1"
                        >
                            {greeting}
                        </motion.p>
                        <motion.h1
                        ...
                        <p className="text-teal-100/90 text-sm md:text-base mt-2 font-medium max-w-md">
                ...
                <div className="flex items-center gap-3 mt-4">
                    <motion.a
                        ...
                        whileHover="hover"
                        whileTap="tap"
                        className="flex-1 group relative flex items-center justify-center gap-3 bg-white text-teal-700 h-14 rounded-[20px] font-black text-[10px] uppercase tracking-[0.2em] shadow-xl hover:shadow-2xl transition-all overflow-hidden border border-white"
                    >
                        <div className="absolute inset-0 bg-teal-50/50 translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-700" />
                ...
                <div className="text-center mt-3">
                    <p className="text-[10px] text-white/50 font-bold uppercase tracking-[0.3em]">Modern Education Theme</p>
                </div>
            </PageItem>

            <PageItem className="grid grid-cols-2 gap-4">
                <Link href="/refer" className="block h-full">
                    <div className="group bg-gradient-to-br from-orange-500 to-orange-600 text-white rounded-[24px] p-6 flex flex-col items-center justify-center gap-3 shadow-[0_15px_30px_-10px_rgba(29,78,216,0.2)] transition-all relative overflow-hidden h-full min-h-[140px]">
                ...
                <Link href="/design/teal-coral/analytics" className="block h-full">
                    <div className="group bg-gradient-to-br from-orange-500 to-orange-600 text-white rounded-[24px] p-6 flex flex-col items-center justify-center gap-3 shadow-[0_15px_30px_-10px_rgba(20,184,166,0.2)] transition-all relative overflow-hidden h-full min-h-[140px]">
            ...
            <PageItem className="glass-panel rounded-[32px] md:rounded-[40px] border border-slate-200/50 dark:border-white/10 overflow-hidden">
                <div className="flex items-center justify-between p-6 border-b border-slate-100/50 dark:border-white/5">
                    ...
                    <div className="flex gap-2">
                        <Link href="/referrals" className="text-xs font-bold text-teal-600 uppercase tracking-wider flex items-center gap-1 hover:bg-teal-50 px-3 py-1.5 rounded-full transition-colors">
                ...
                {recentReferrals.length === 0 ? (
                    <div className="p-12 text-center">
                        ...
                        <Link
                            href="/refer"
                            className="inline-flex items-center gap-2 bg-gradient-to-r from-orange-500 to-orange-600 hover:from-blue-700 hover:to-blue-800 text-white px-6 py-3 rounded-full font-bold text-sm transition-all shadow-lg hover:shadow-xl"
                        >
                            <UserPlus size={18} />
                            Make First Referral
                        </Link>
